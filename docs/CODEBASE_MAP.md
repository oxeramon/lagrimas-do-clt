...
graph TB
    ...
    subgraph "Verificação local"
        Regras["testes/regras.mjs<br/>434 casos"]
...
| `testes/regras.mjs` | 434 casos, importando os mesmos módulos do navegador | ~1645 |
| `testes/fluxos.mjs` | 355 casos num navegador de verdade | ~1620 |
...
| `goals-screen.js` | metas, alocações, a regra mensal e as competências pendentes | ~560 |
